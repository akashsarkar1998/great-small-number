# # # Find greatest number in a list using function:
...
# # # Find second greatest number in a list:
...
# # # Find second greatest number in a list using sort() method:
# my_list = []
# n= int(input("Enter how many number you want in list: "))
# if n>1:
#     for i in range(0, n):
...
# # Find greatest number in a list using sort() method:
# my_list = []
# n= int(input("Enter how many number you want in list: "))
# if n>1:
#     for i in range(0, n):
...
# # ****** Find Max or Min number from a list:
# list= [32, 45, 34, 65, 9]
# max_num = max(list)
# min_num= min(list)
# print(max_num)
...
#*****
#To find Min Value Accumulation!
